...
import { canonical, within, agentDir, sharedSkills } from './paths.mjs';
...
export function checkFilePath(input, cwd, write, readOnly, extraReadRoots = []) {
  ...
  if (write && !skill && [agentDir].some(p => within(target, canonical(p)))) throw new Error('Harness state is protected');
